				...
				<div class="p-6 text-gray-900">
					<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
						<section class="max-w-4xl p-6 mx-auto bg-indigo-600 rounded-md shadow-md dark:bg-gray-800 mb-10 justify-center align-middle">
							<h1 class="text-xl font-bold text-white capitalize dark:text-white">Ürün Ekle</h1>
							<form action="{{ route('products.store') }}" method="POST">
								...
								<div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
									...
									<div>
										...
										<input type="text" name="category_name" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
									</div>
									<div>
									...
									<div>
										...
										<input id="date" name="updated_at" type="date" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
									</div>
									<div>
										<label class="text-white dark:text-gray-200">Açıklama</label>
										<textarea id="textarea" name="description" type="textarea" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"></textarea>
									</div>
									<div>
									...
									<div>
										...
										<input id="name" name="image" type="string" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
									</div>
								</div>
								<div class="flex justify-end mt-6">
									<button type="submit" onclick="alert('Urun eklendi')" class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray-500 rounded-md hover:bg-gray-700 focus:outline-none focus:bg-gray-600">Kaydet</button>
								</div>
					</div>
